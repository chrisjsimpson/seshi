...
* [generateKey](https://bitbucket.org/chrisjsimpson/seshi/overview#markdown-header-generateKey) - Return a key (string). Used when setting up a peer connection. This is used by the signalingServer.
